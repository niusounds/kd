...
Java_com_niusounds_kd_wdl_Resampler_nativeInit(JNIEnv *env, jobject thiz) {
    return reinterpret_cast<jlong>(new WDL_Resampler());
}

JNIEXPORT void JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeRelease(JNIEnv *env, jobject thiz, jlong ptr) {
    delete reinterpret_cast<WDL_Resampler *>(ptr);
}

JNIEXPORT void JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeSetMode(JNIEnv *env, jobject thiz, jlong ptr,
                                                  jboolean interp,
...
JNIEXPORT void JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeSetFilterParms(JNIEnv *env, jobject thiz, jlong ptr,
...
JNIEXPORT void JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeSetFeedMode(JNIEnv *env, jobject thiz, jlong ptr,
...
JNIEXPORT void JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeReset(JNIEnv *env, jobject thiz, jlong ptr,
                                                jdouble fracpos) {
    auto resampler = reinterpret_cast<WDL_Resampler *>(ptr);
...
JNIEXPORT void JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeSetRates(JNIEnv *env, jobject thiz, jlong ptr,
                                                   jdouble rateIn,
                                                   jdouble rateOut) {
    auto resampler = reinterpret_cast<WDL_Resampler *>(ptr);
...
Java_com_niusounds_kd_wdl_Resampler_nativeGetCurrentLatency(JNIEnv *env, jobject thiz, jlong ptr) {
    auto resampler = reinterpret_cast<WDL_Resampler *>(ptr);
    return resampler->GetCurrentLatency();
}

JNIEXPORT jint JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeResamplePrepare(JNIEnv *env, jobject thiz, jlong ptr,
...
JNIEXPORT jint JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeResamplePrepareFloatArray(JNIEnv *env, jobject thiz,
                                                                    jlong ptr,
                                                                    jint reqSamples, jint nch,
                                                                    jfloatArray buffer) {
    auto resampler = reinterpret_cast<WDL_Resampler *>(ptr);
...
JNIEXPORT jint JNICALL
Java_com_niusounds_kd_wdl_Resampler_nativeResampleOut(JNIEnv *env, jobject thiz, jlong ptr,
                                                      jobject out,
